...
<td width="246">
<p>اجزایی از برنامه که از کلاس Meesage استفاده می‌کنند به یک نوع کلاس وابسته هستند که این مورد این قانون را نقض می‌کند. اجزای برنامه باید به اجزای انتزاعی (اینترفیس) وابسته باشند.</p>
</td>
<td width="284">
<p>برای حل این مشکل کافی است Message را بجای کلاس بودن تبدیل به اینترفیس کنیم</p>
</td>
</tr>
</tbody>
</table>
...
با توجه به جدول بالا مشخص است که از انجام کدام تغییرات معاف می‌شویم.


# جمع بندی

در این بخش نتیجه گرفتیم که استفاده از اصول SOLID نگهداری و توسعه‌ی برنامه‌ی ما را بسیار راحت تر می‌کند و حتی در مواقعی اگر استفاده نشود توسعه غیرممکن می‌شود ولی در صورت رعایت به راحتی می‌توان محصول را روز به روز توسعه داد.
